  ...
  return (
    <ContextMenuPortal>
      <ContextMenuPrimitive.SubContent
        ...
        className={cn(
          "z-50 min-w-52 overflow-hidden rounded-lg bg-popover p-1.5 text-popover-foreground shadow-surface-strong data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
          className
        )}
        {...props}
      />
